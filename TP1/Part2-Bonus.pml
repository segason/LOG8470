...
active proctype M_1() priority 1
{	
	do
	:: if
...
active proctype M_2() priority 5
{	
	do
...
{	
	...
	do
	::  if
		::(tour == 0 && nempty(canal_ECS) && empty(canal_FCS) && empty(canal_LGS) && nfull(canal_MDS)) -> canal_ECS?msg(receive); canal_MDS!msg,receive; nmsgrecu++;
		::else -> skip
		fi
